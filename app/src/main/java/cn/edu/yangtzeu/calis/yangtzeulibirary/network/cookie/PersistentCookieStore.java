...
public class PersistentCookieStore {
    ...
    public void add(HttpUrl url, Cookie cookie) {
        ...
        ConcurrentHashMap<String, Cookie> cookieConcurrentHashMap = cookies.get(url.host());
        if (cookieConcurrentHashMap != null) {
            //将cookies持久化到本地
            SharedPreferences.Editor prefsWriter = cookiePrefs.edit();
            prefsWriter.putString(url.host(), TextUtils.join(",", cookieConcurrentHashMap.keySet()));
